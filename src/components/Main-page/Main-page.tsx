...
const MainPage: React.FC = () => {
  ...
  const [menuActive, setMenuActive] = useState(false);
    ...
    {value: "Fruits", href: './actionC', image: 'apple.svg', id: 3}, {value: "Color", href: './adjective', image: 'yellow.svg', id: 4}, {value: "Animal (set A)", href: './animalA', image: 'cat.jpg', id: 5}, {value: "Animal (set B)", href: './animalB', image: 'bird.jpg', id: 6}, 
